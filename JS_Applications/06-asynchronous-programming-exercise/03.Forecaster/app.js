function attachEvents() {
    ...
    function getWeather(e) {
        fetch('http://localhost:3030/jsonstore/forecaster/locations')
            .then(res => res.json())
            .then(data => {
                let currentOutput = forecastOutput.querySelector('#current');
                let upcomingOutput = forecastOutput.querySelector('#upcoming');
                ...
                let upcomingWeatherPromise = fetch(`http://localhost:3030/jsonstore/forecaster/upcoming/${foundLocation.code}`)
                    ...
                    .then(upcomingWeather => {
                        let upcomingWeatherDiv = createUpcomingWeather(upcomingWeather, conditions);
                ...
                function createUpcomingWeather(upcomingWeatherObj, conditions) {
