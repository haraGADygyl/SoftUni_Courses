...
// console.log(summerCamp.registerParticipant("Petar Petarson", "student", 2100));
// console.log(summerCamp.registerParticipant("Petar Petarson", "student", 300));
// console.log(summerCamp.registerParticipant("Petar Petarson", "student", 700));
...
console.log(summerCamp.registerParticipant('Sara Dickinson', 'child', 200));
console.log(summerCamp.registerParticipant('test1', 'collegian', 666));
console.log(summerCamp.registerParticipant('test2', 'collegian', 666));
// console.log(summerCamp.unregisterParticipant('Sara Dickinson'))
// console.log(summerCamp.timeToPlay("WaterBalloonFights", "Petar Petarson", "Sara Dickinson"));
console.log(summerCamp.timeToPlay("WaterBalloonFights", "test1", "test2"));
